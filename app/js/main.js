...
function modal() {
  ...
  const popupOrder = document.querySelector('.modal__order');
  const close = document.querySelectorAll('.modal__btn-close');
...
const forms = () => {
  ...
  var button = document.querySelector('.modal__btn');
